...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("BPEmailAdressesListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onTheBPEmailAdressesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheBPEmailAdressesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheBPEmailAdressesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheBPEmailAdressesListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheBPEmailAdressesListGenerated.onFilterBar().iExecuteSearch();
            Then.onTheBPEmailAdressesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onTheBPEmailAdressesListGenerated.onTable(defaultTableId).iPressRow(0);
            Then.onTheBPEmailAdressesObjectPageGenerated.iSeeThisPage();
        });

...
sap.ui.define([
    ...
    function journey() {
        ...
        opaTest("Check body sections of the Object Page", function (Given, When, Then) {
            Then.onTheProductsObjectPageGenerated.iCheckSection({ section: "FieldGroup::General" });
            Then.onTheProductsObjectPageGenerated.onForm({ section: "FieldGroup::General" }).iCheckField({ property: "name" });
            Then.onTheProductsObjectPageGenerated.onForm({ section: "FieldGroup::General" }).iCheckField({ property: "stock" });
            Then.onTheProductsObjectPageGenerated.onForm({ section: "FieldGroup::General" }).iCheckField({ property: "price" });
       });
